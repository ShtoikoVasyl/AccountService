...
ACCOUNT_SERV_REST_SERVER_PORT=8007
EUREKA_URL="my-eureka-url"
ACTIVE_PROFILE="prod"

IMAGE_NAME="account_serv"

EXTERNAL_IP=$(hostname -I | awk '{print $1}')


docker run -d -p ${ACCOUNT_SERV_REST_SERVER_PORT}:${ACCOUNT_SERV_REST_SERVER_PORT} \
  -e CONFIG_SERVER_PASSWORD=${CONFIG_SERVER_PASSWORD} \
  -e CONFIG_SERVER_USERNAME=${CONFIG_SERVER_USERNAME} \
  -e REST_SERVER_PORT=${ACCOUNT_SERV_REST_SERVER_PORT} \
